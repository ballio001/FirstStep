...
namespace DarkTonic.CoreGameKit {
    ...
    public class TriggeredWaveSpecifics {
        ...
        public KillerFloat repeatWavePauseMax = new KillerFloat(.1f, .1f, float.MaxValue);
        ...
        public WaveSpecifics.ScaleMode curScaleMode = WaveSpecifics.ScaleMode.UsePrefabScale;
