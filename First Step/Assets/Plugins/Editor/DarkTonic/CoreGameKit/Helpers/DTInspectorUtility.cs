...
public static class DTInspectorUtility {
    ...
    public static void ShowTopGameObjectNotPrefabMessage() {
        ShowColorWarningBox("If you are in Project View, click the button below to create a Scene object. If this is a Scene object, make a prefab out of it to complete the process so it can be recognized as a prefab.");
    }
