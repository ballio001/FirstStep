...
public class WaveSyncroPrefabSpawnerInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        DTInspectorUtility.ShowCollapsibleSection(ref newExpanded, text);
        ...
        if (_settings.activeMode != LevelSettings.ActiveItemMode.Never) {
            ...
            GUI.contentColor = Color.white;
            DTInspectorUtility.AddHelpIconNoStyle("http://www.dtdevtools.com/docs/coregamekit/SyncroSpawners.htm#WaveSettings");
