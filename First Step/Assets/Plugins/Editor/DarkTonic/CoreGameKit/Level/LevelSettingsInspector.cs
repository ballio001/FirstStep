...
public class LevelSettingsInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        DTInspectorUtility.AddHelpIconNoStyle("http://www.dtdevtools.com/docs/coregamekit/LevelWaveSettings.htm#PoolBoss");
        ...
        DTInspectorUtility.AddHelpIconNoStyle("http://www.dtdevtools.com/docs/coregamekit/LevelWaveSettings.htm#PrefabPools");
        ...
        GUILayout.Space(2f);
        DTInspectorUtility.AddHelpIconNoStyle("http://www.dtdevtools.com/docs/coregamekit/LevelWaveSettings.htm#SyncroSpawners");
        EditorGUILayout.EndHorizontal();
        ...
        DTInspectorUtility.AddHelpIconNoStyle("http://www.dtdevtools.com/docs/coregamekit/LevelWaveSettings.htm#WorldVariables");
        ...
        DTInspectorUtility.AddHelpIconNoStyle("http://www.dtdevtools.com/docs/coregamekit/LevelWaveSettings.htm#LevelsWaves");
        ...
        DTInspectorUtility.AddHelpIconNoStyle("http://www.dtdevtools.com/docs/coregamekit/LevelWaveSettings.htm#CustomEvents");
        ...
        if (_settings.showCustomEvents) {
            ...
            for (var c = 0; c < _settings.customEventCategories.Count; c++) {
                ...
                if (!cat.IsEditing || Application.isPlaying) {
                    ...
                    DTInspectorUtility.ShowCollapsibleSection(ref state2, text2);
